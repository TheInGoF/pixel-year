...
▶️ **[Provalo online](https://theingof.github.io/pixel-year/)** — funziona nel browser, senza installazione.

🖥️ **Interfaccia dell'app** in 27 lingue: 🇪🇺 tutte le lingue dell'UE · 🇳🇴 · 🇯🇵

> **Idea 100% human · Code 95% LLM**

<p align="center"><img src="images/gif/pixel-year-demo.gif" alt="Pixel Year — demo animata" width="384"></p>
...
- **Layout:** griglia a pixel (verticale / orizzontale) e matrice dei mesi (3×4 / 4×3, veri
  mini-calendari settimanali).
- **Inizio settimana** lunedì o domenica (predefinito secondo il paese); domeniche in rosso.
- Opzione per **nascondere l'anno**.
- Celle da 5 mm in scala reale; i calendari orizzontali si impilano su A4 e una singola
  matrice dei mesi si stampa su A5/A6.
...
Scegli un layout dal menu **Layout**:

- **Griglia a pixel** — il classico “Year in Pixels”: mesi come colonne, giorni 1–31 come
  righe. Disponibile in **verticale** o **orizzontale** (trasposto: giorni come colonne, mesi
  come righe; stampa impilata su A4 verticale).
- **Matrice dei mesi (3×4 o 4×3)** — dodici veri mini-calendari mensili, una panoramica annuale
  stampabile. Un singolo anno si stampa sul formato più piccolo che lo contiene (**A5**, persino
  **A6** con celle piccole); due anni stanno su un A4.

<p align="center">
  <img src="images/preview-matrix-it.png" alt="Layout a matrice dei mesi (3×4)" width="300">
  <img src="images/preview-landscape-it.png" alt="Layout orizzontale" width="420">
</p>
